...
chsource = Redis:get(Fast..'chsource') or "SOURCEHORSE "
...
ControllerAll = false
local ListSudos = {Sudo_Id,6059195246,5523863949,5885798452}
...
xname =  (Redis:get(Fast.."Name:Bot") or "زومبي") 
...
if tonumber(senderr) == 6059195246 then
msg.Name_Controller = 'المطور بلال'
msg.The_Controller = 1
elseif tonumber(senderr) == 5512718660 then
...
return send(msg_chat_id,msg_id,' ⚡ تم استرجاع المجموعات من نسخه زومبي\n√')
else
...
if text == (Redis:get(Fast.."Bot:Name") or "زومبي") then
local photo = bot.getUserProfilePhotos(Fast)
if photo.total_count > 0 then
local NamesBot = (Redis:get(Fast.."Bot:Name") or "زومبي")
local Mostafa = {
'• مالك حبيبى 🥺',
...
if text == (Redis:get(Fast.."Name:Bot") or "زومبي") then
local photo = bot.getUserProfilePhotos(Fast)
if photo.total_count > 0 then
local NamesBot = (Redis:get(Fast.."Name:Bot") or "زومبي")
local Mostafa = {
'• مالك حبيبى 🥺',
'• مخصماك وبعد عني مش طيقاك 😹',
'• مبكلمكش 🥺',
...
local Name = "*⊷⌯⧼᥉᥆υᖇᥴᥱ 𝗁᥆ᖇ᥉ᥱ⧽⌯⊶\n*★‹ [᥉᥆υᖇᥴᥱ 𝗁᥆ᖇ᥉ᥱ](http://t.me/SOURCEHORSE )*\n*★‹ [𝐀𝐒𝗞 𝗧𝐎 𝐌𝗘](http://t.me/SOURCEHORSE )*\n*★‹ [𝐙𝐎𝐌𝐁𝐈𝐄](http://t.me/Zo_Mbi_e)*\n*★‹ [𝐊𝐈𝐌𝐌𝐘](t.me/TOPHORSE )*\n*★‹ [𝐁𝐀𝐁𝑳𝐎𝐎](t.me/DEV_BABLOO)*\n⊷⌯⧼᥉᥆υᖇᥴᥱ 𝗁᥆ᖇ᥉ᥱ⧽⌯⊶*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝐕𝐄𝐆𝐀 𝐒𝐓𝐎𝐑𝐄🥇', url = 't.me/HORSE _MAKER_bot?start'}
},
{
...
local Name = "𝐖𝐄𝑳𝐂𝐎𝐌𝐄 𝐓𝐎 𝐕𝐄𝐆𝐀 𝐒𝐓𝐎𝐑𝐄\n"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝐕𝐄𝐆𝐀 𝐒𝐓𝐎𝐑𝐄🥇', url = 't.me/MK1_HORSE _bot?start'}
},
{
{text = '𝐀𝐃𝐃 𝐌𝐄💞', url = 't.me/'..UserBot..'?startgroup=new'}
},
...
local m = "https://t.me/SOURCEHORSE /1188"
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text == 'المطور زومبي' or text == 'المطور زومبي' or text == 'زومبي' or text == 'احمد' or text == 'الهكر' then  
local UserId_Info = bot.searchPublicChat("Zo_Mbi_e")
...
if photo.total_count > 0 then
local DevJabwa = "*▷ 𝐃𝐄𝐕 ᥉᥆υᖇᥴᥱ 𝗁᥆ᖇ᥉ᥱ 𝐙𝐎𝐌𝐁𝐈𝐄 ♯*\n*▷ɴᴀᴍᴇ 𝐙𝐎𝐌𝐁𝐈𝐄 ⇿ *"..ban.first_name.."\n*▷ ɪᴅ 𝐙𝐎𝐌𝐁𝐈𝐄 ⇿ "..UserId_Info.id.."*\n*▷ ʙɪᴏ 𝐙𝐎𝐌??𝐈𝐄 ⇿*  *"..Bio.." *"
keyboardd = {} 
...
if text == 'المطور كيمي' or text == 'المبرمج كيمي' or text == 'كيمي' or text == 'kimmy' then  
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local DevJeka1 = "*𓄼•𝐃𝐄𝐕 ᥉᥆υᖇᥴᥱ 𝗁᥆ᖇ᥉ᥱ 𝐊𝐈𝐌𝐌𝐘*\n*𓄼•𝙽𝙰𝙼𝙴 𝐊𝐈𝐌𝐌𝐘 ⇿ *"..ban.first_name.."\n*𓄼•𝙸𝙳 𝐊𝐈𝐌𝐌𝐘 ⇿ "..UserId_Info.id.."*\n*𓄼•𝙱??𝙾 𝐊𝐈𝐌𝐌𝐘 ⇿*  *"..Bio.." *"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
...
data = {
{
{text = '⌁ ᥉᥆υᖇᥴᥱ 𝗁᥆ᖇ᥉ᥱ ⚡', url = "https://t.me/SOURCEHORSE "}
},
}
}
...
{
{text = '✶ اضغط لتنصيب بوتك 💗ˣ.', url = "https://t.me/MK1_HORSE _bot"}
},
}
}
...
local Bot_Name = (Redis:get(Fast.."Name:Bot") or "زومبي")
if text then
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = ' '..UserInfo.first_name..' ', url = 't.me/'..UserInfo.username}, },{{text = '⌁ ᥉᥆υᖇᥴᥱ 𝗁᥆ᖇ᥉ᥱ ⚡', url = 't.me/SOURCEHORSE '},},}}
...
if photo and photo.total_count and photo.total_count > 0 then
local Text = " ⚡ عدد صوره هو ⇿ "..photo.total_count.." صوره"
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = ' '..UserInfo.first_name..' ', url = 't.me/'..UserInfo.username}, },{{text = '⌁ 𝑺𝑶𝑼𝑹𝑪𝑬 𝑺??𝑰𝑫𝑰 ⚡', url = 't.me/SOURCEHORSE '},},}}
bot.sendPhoto(msg_chat_id, msg_id, photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id, Text, "md", true, nil, nil, nil, nil, nil, nil, nil, nil, reply_markup)
else
return bot.sendText(msg_chat_id,msg_id,'* ⚡ لا توجد صوره ف حسابك*',"md",true) 
end
...
{
{text = '◜ َٰ᥉᥆υᖇᥴᥱ 𝗁᥆ᖇ᥉ᥱ◞', url = 'https://t.me/SOURCE_HORSE'}, 
},
}
}
